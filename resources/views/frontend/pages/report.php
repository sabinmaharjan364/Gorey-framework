<?php 
    ...
    include(FRONTEND."include/nav.php");
		...
		<article>
			...
			//   require(FRONTEND.'include/slider.php');?>
	  		<section class="row center">
				<h1>ReadMe and information file</h1>
			...
			<div class="col-id-2"></div>
				<div class="col-id-2">
					<li><a href="http://localhost/bookstore/project.txt">ReadMe.txt file</a></li>
					<hr>
					<li><a href="http://localhost/bookstore/project.txt">Project.txt file</a></li>
					<hr>
										
				</div>
				<div class="col-id-6">

					<li><a href="http://localhost/bookstore/readMe.txt">
					Contains small documentation of this Application.
					</a></li>
					<hr>
					<li><a href="http://localhost/bookstore/project.txt">Contains the information about this project</a></li>
					<hr>
				</div>
				<div class="col-id-2"></div>
			...
			<section class="row">
				...
				<div class="col-id-8">
					...
					<p>
						...
						<li>
							This website is fully supported by Google Chrome and firefox
						</li>
						<li>
							File structure and documentation are provide in 
						</li>
			...
			<section class="row center">
				<h1>Source of image and text</h1>
			...
			<section class="row profile_images">
				<h1 class="center">Profile images</h1>
