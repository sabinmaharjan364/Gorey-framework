      ...
      <?php 	?>	<br>	<br>
			...
			<section class="row">
				...
				<div class="col-id-4 form_body">
				    ...
				    <form id="login_form"  action="<?php echo SITEROOT ;?>authors/create"  method="post" enctype="multipart/form-data">	
                        <fieldset>
                            <legend>Add</legend>
                                            
                                <div class="col-id-12">
                                    <label for="full_name">Title </label><div id="err-full_name"></div>
                                    <input type="text" class="form-control" id="full_name"  name="full_name" placeholder="Titlte" required>
                                </div>
								<div class="col-id-12">
                                ...
                                <div class="col-id-12 ">
                                    <label for="DOB">DOB/label><div id="err-DOB"></div>
